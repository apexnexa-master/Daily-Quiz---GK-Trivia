...
class GameIntroData {
  ...
  static const Map<String, GameIntroData> games = {
    'arrow-puzzle': GameIntroData(
      ...
      titleBn: 'এরো পাজল',
      titleHi: 'एरो पज़ल',
      tagline: 'Tap. Slide. Escape.',
      taglineBn: 'ট্যাপ করুন। স্লাইড করুন। বেরিয়ে পড়ুন।',
      taglineHi: 'टैप करें। स्लाइड करें। बाहर निकलें।',
      ...
      rules: [
        'The board is packed with blocks of different sizes',
        'Each block has an arrow showing its exit direction',
        'Tap a block to fly it off the board — only if its path is clear',
        'A blocked tap costs a heart — you have 3',
        'Stuck? Use a hint or undo your last move',
      ],
      rulesBn: [
        'বোর্ড ভরা বিভিন্ন আকারের ব্লকে',
        'প্রতিটি ব্লকে বেরোনোর দিক দেখানো তীর আছে',
        'রাস্তা ফাঁকা থাকলে ট্যাপ করেই ব্লক উড়ে বেরোবে',
        'আটকালে একটি হার্ট কমবে — মোট ৩টি',
        'আটকে গেলে হিন্ট বা আনডু ব্যবহার করুন',
      ],
      rulesHi: [
        'बोर्ड अलग-अलग आकार के ब्लॉकों से भरा है',
        'हर ब्लॉक पर निकासी दिशा दिखाने वाला तीर है',
        'रास्ता खाली हो तो टैप करते ही ब्लॉक उड़ जाएगा',
        'अवरोध पर एक हार्ट कटेगा — कुल 3',
        'फँस जाएँ तो हिंट या अनडू लें',
      ],
      targetRoute: '/arrow-maze',
    ),
    ...
    'arrow-silhouette': GameIntroData(
      id: 'arrow-silhouette',
      title: 'ARROW SILHOUETTE',
      titleBn: 'এরো সিলুয়েট',
      titleHi: 'एरो सिल्हूट',
      tagline: 'Escape the silhouette. One tap at a time.',
      taglineBn: 'সিলুয়েট থেকে পালান। একবারে একটি ট্যাপ।',
      taglineHi: 'सिल्हूट से बचें। एक समय में एक टैप।',
      icon: Icons.alt_route_rounded,
      accentColor: Color(0xFF00F1FE),
      secondaryColor: Color(0xFF8B5CF6),
      brainBenefit:
          'Sharpens spatial reasoning, cascade planning, and sequential problem solving. Arranging arrows into recognizable silhouettes activates your parietal cortex while escaping them requires multi-step strategic thinking — strengthening your prefrontal cortex for complex planning.',
      brainBenefitBn:
          'স্থানিক যুক্তি, ক্যাসকেড পরিকল্পনা ও ক্রমিক সমস্যা সমাধান তীক্ষ্ণ করে। তীর চিহ্নিত আকৃতিতে সাজানো প্যারিটাল কর্টেক্স সক্রিয় করে।',
      brainBenefitHi:
          'स्थानिक तर्क, कैस्केड योजना और क्रमिक समस्या समाधान तेज करता है। तीरों को मान्यता प्राप्त सिल्हूट में व्यवस्थित करना पैरिएटल कॉर्टेक्स को सक्रिय करता है।',
      rules: [
        'Long arrows form recognizable silhouettes',
        'Tap an arrow to escape it if its path is clear',
        'Blocked arrows flash red — plan ahead',
        'Arrows escape along their own direction',
        'Cascade: removing one may free others',
      ],
      rulesBn: [
        'লম্বা তীর চেনা যায় এমন আকৃতি তৈরি করে',
        'তীরের পথ ফাঁকা থাকলে ট্যাপ করে বের করুন',
        'আটকা তীর লাল হয়ে জ্বলে — আগে ভাবুন',
        'তীর নিজের দিকে বের হয়',
        'একটি সরালে অন্যরা ফাঁকা হতে পারে',
      ],
      rulesHi: [
        'लंबे तीर पहचानने योग्य सिल्हूट बनाते हैं',
        'तीर का रास्ता खाली हो तो टैप करके बाहर निकालें',
        'अवरोधित तीर लाल होकर चमकते हैं — आगे सोचें',
        'तीर अपनी दिशा में बाहर निकलते हैं',
        'एक हटाने से दूसरे फँसे तीर छूट सकते हैं',
      ],
      targetRoute: '/arrow-silhouette',
    ),
  };
}
